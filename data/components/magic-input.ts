...
const component: ComponentProps = {
  ...
  name: "Magic Input",
  slug: "magic-input",
  description: "An input field with an animated, glowing border and a matrix-style background effect on focus.",
  category: "UI",
  code: {
    tsx: `
"use client";
...
export default MagicInput;
  ...
  props: [
    { name: "placeholder", type: "string", defaultValue: "Enter your secret...", description: "Placeholder text for the input." },
    { name: "containerClassName", type: "string", description: "Additional classes for the main container." },
    { name: "className", type: "string", description: "Additional classes for the input element." },
  ],
};
