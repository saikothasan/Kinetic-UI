...
const component: ComponentProps = {
  ...
  description: "A stunning, interactive 3D globe with animated arcs.",
...
export default InteractiveGlobe;
  ...
  props: [
    { name: "pointColor", type: "color", defaultValue: "#6366f1", description: "Color of the points on the globe." },
    { name: "arcColor", type: "color", defaultValue: "#a855f7", description: "Color of the animated arcs." },
    { name: "globeRadius", type: "number", defaultValue: 2.5, description: "The radius of the globe sphere." },
    { name: "pointsCount", type: "number", defaultValue: 5000, description: "Number of points to render on the globe." },
    { name: "arcsCount", type: "number", defaultValue: 10, description: "Number of animated arcs." },
    { name: "arcMaxAltitude", type: "number", defaultValue: 1.5, description: "Maximum altitude of the arcs from the globe surface." },
    { name: "autoRotateSpeed", type: "number", defaultValue: 0.2, description: "Speed of the automatic rotation. Set to 0 to disable." },
  ],
};
