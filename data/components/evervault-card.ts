...
const component: ComponentProps = {
  ...
  name: "Evervault Card",
  slug: "evervault-card",
  description: "A card with an animated, glowing mesh background that is revealed on hover.",
  category: "Cards",
  code: {
    tsx: `
"use client";
...
export default EvervaultCard;
  ...
  props: [
    { name: "children", type: "ReactNode", description: "The content to display inside the card." },
